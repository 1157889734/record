/**********************************************************************
  ...
  文件名称:  types.h
  文件描述: SZBeiHai 公司mp3 encodec head file
...
#define MAX_RECORD_TIME     (30*60)      //最大录音时间,1800秒
#define RATE                             44100//16000       //采样频率
#define SIZE                              16         //量化位数
...
extern pthread_cond_t    wait_record_mp3;            /*操作录音的条件变量*/
extern pthread_mutex_t  lock_wait_record_mp3;   /*条件变量的互斥锁*/
